...
public class FifteenClass {
    ...
    public static void main(String[] args) {
        ...
        if (isShowStatistic) {
            ...
            System.out
                    .println("Открытые состояния: " + astar.getClosedStatesCount());
        }
    }
    ...
    private static boolean isShowStatistic = true;    // Показать статистику (Время, длину решения, кол-во открытых состояний)
}
